    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      >
        ...
        <form className="space-y-6">
          ...
          <button className="animate-item w-full py-4 bg-[#D4AF37] hover:bg-[#B8860B] text-black font-bold rounded-2xl flex items-center justify-center gap-2 transition-all shadow-[0_0_30px_rgba(212,175,55,0.3)] active:scale-95 group">
            Sign In
